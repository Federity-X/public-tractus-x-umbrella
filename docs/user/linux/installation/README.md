...
For detailed instructions on installing the Umbrella Chart, please refer to the [Linux Deployment Guide](../README.md#3-installation).
...
- [sdfactory](https://github.com/eclipse-tractusx/sd-factory/tree/sdfactory-2.1.35)
...
- [tx-data-provider](https://github.com/eclipse-tractusx/tractus-x-umbrella/tree/main/charts/tx-data-provider)
  ...
  - [digital-twin-bundle](../../../../charts/digital-twin-bundle)
    - [digital-twin-registry](https://github.com/eclipse-tractusx/sldt-digital-twin-registry/tree/digital-twin-registry-0.10.0)
...
- [identity-and-trust-bundle](../../../../charts/identity-and-trust-bundle)
  ...
  - [tractusx-identityhub-memory](https://github.com/eclipse-tractusx/tractusx-identityhub/tree/v0.3.2) — alias `identity-hub`, in-memory IdentityHub (`wallet.mode=identityHub`)
  - [tractusx-identityhub](https://github.com/eclipse-tractusx/tractusx-identityhub/tree/v0.3.2) — alias `identity-hub-postgres`, PostgreSQL-backed IdentityHub (`wallet.mode=identityHub`)
  - [tractusx-issuerservice](https://github.com/eclipse-tractusx/tractusx-identityhub/tree/v0.3.2) — alias `issuer-service`, the DCP credential issuer (`wallet.mode=identityHub`)
...
> :warning: **Note**
>
> Please be aware of [Note for R24.05](/docs/user/common/note-r2405-onwards)
>
